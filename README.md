...
- **Enhanced geothermal** taps heat from deep hot rock anywhere, not just volcanic regions. Fervo Energy's 2023 Nevada demonstration proved commercial-scale power from non-volcanic geology. It provides firm, carbon-free baseload — no batteries needed. But most projections cap enhanced geothermal at roughly 10–15% of US electricity demand, making it a valuable baseload complement to solar rather than a replacement. Cheap and carbon-free, but not the whole answer.
- **Nuclear fission** already supplies ~10% of global electricity, and South Korea, France, and China have demonstrated that nuclear-heavy grids work at national scale. The technology is proven, carbon-free, and already safer than fossil fuels by deaths-per-TWh (even including Chernobyl and Fukushima). But it is not cheap: even in the countries that build best, nuclear plants cost $5–10B and take 5–15 years to construct. Almost all the cost is upfront capital; once built, operating costs are low and the power is carbon-free for 40–60 years. Nuclear does not follow an S-curve — costs have historically *increased* over time (negative learning curve), driven largely by regulatory and construction complexity. SMRs (NuScale, Rolls-Royce, X-energy) promise lower capital costs through factory fabrication, but none have reached commercial operation yet. If regulatory reform or SMR designs can bring construction costs down while maintaining safety, nuclear becomes a much stronger complement to solar. That is a plausible but speculative story.
...
- **Nuclear fission and SMRs**: World Nuclear Association 2024 country profiles; NuScale Power UAMPS project; Rolls-Royce SMR design acceptance (UK ONR). [38]
- **Enhanced geothermal**: Fervo Energy 2023 Cape Station demonstration (3.5 MW, non-volcanic geology); Quaise Energy deep drilling concept. [39]
