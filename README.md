...
- **Ecology**: restored forests, recovering biodiversity, stabilized nitrogen and phosphorus cycles — because the agricultural and energy footprints shrank. Nitrogen fixation (3.4× the safe limit) is currently *further* beyond its boundary than climate (1.2×), but it is more regional, more reversible (ecosystems recover in decades once runoff stops), and more amenable to technology solutions (precision agriculture cuts nitrogen application 20–40%). Cheap, abundant energy makes precision agriculture, controlled-environment farming, and nitrogen-recovery systems economically viable.
