...
- **Nuclear fission** supplies ~10% of global electricity and is proven, carbon-free, and extremely safe (0.03 deaths/TWh vs coal's 24.6). But new nuclear is expensive ($141–221/MWh vs $24–96 for solar) and — uniquely among energy technologies — shows *no learning curve*; costs have *increased* in most countries. The exceptions (France, South Korea) achieved cost control through design standardization, not deregulation. Nuclear's strongest case is for *firm power*: when 24/365 guaranteed supply is required, system-level costs for solar ($413–1,548/MWh) and wind ($291–504/MWh) far exceed nuclear ($106–122/MWh), because nuclear doesn't need backup. Factory-fabricated SMRs could in principle deliver Wright's Law cost reductions through serial production — but this is plausible, not demonstrated. Nuclear is a valuable baseload complement to solar for the fraction of the grid that cannot tolerate intermittency. [Detailed cost data, learning-curve analysis, and Berthélemy & Rangel findings in the [archive](analysis/ARCHIVE.md#nuclear-detailed).]
