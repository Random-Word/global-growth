...
7. **Abundant cheap clean energy is the master key — but not the only lock.** Solar generation grew from 4 TWh (2005) to 2,128 TWh (2024), doubling every ~3.2 years. This S-curve, if it continues, unlocks cascading solutions: electrification eliminates the carbon boundary, cheap desalination addresses freshwater, cheap energy makes recycling and circular economy economically dominant, and cheap energy powers the precision agriculture and controlled-environment farming that could address the nitrogen and land-use boundaries. Solar is by far the strongest horse in the energy portfolio, but its intermittency creates dependence on battery storage at massive scale. Enhanced geothermal (firm, carbon-free baseload — the DOE estimates 60–90 GW possible in the US alone by 2050, up from 3.7 GW today) and nuclear fission (proven and carbon-free — but new plants cost $141–221/MWh vs solar's $24–96/MWh, and costs have historically *risen* rather than fallen) reduce that battery dependence. Fusion may transform the second half of the century. Energy abundance does not automatically solve the biogeochemical boundaries — those also require bioengineering breakthroughs and governance — but it is the necessary enabling condition for nearly every other solution.
...
**Solar is by far the strongest horse, but it is not the only one.** The energy abundance thesis rests primarily on the solar S-curve, and that is where the weight of the argument should sit. But solar has a real weakness: intermittency requires massive battery storage to provide reliable baseload power, and battery supply chains (lithium, cobalt) face their own scaling constraints. Three complementary technologies reduce that dependence:

- **Enhanced geothermal** taps heat from deep hot rock anywhere, not just volcanic regions. Fervo Energy's 2023 Nevada demonstration proved commercial-scale EGS power from non-volcanic geology; their Cape Station project in Utah is scaling toward 400 MW. It provides firm, carbon-free baseload at 80–90% capacity factor — no batteries needed. The US has ~3.7 GW of conventional geothermal installed today. The DOE's GeoVision study (2019) projected 60 GW by 2050; an updated 2023 Enhanced Shot analysis raised that to 90 GW — roughly 15–17% of current US electricity generation. The MIT "Future of Geothermal Energy" study (2006) estimated US EGS resources at 3–10 km depth exceed 13,000 zettajoules, with 100+ GWe feasible by 2050 given $1B in R&D over 15 years. Current LCOE is $61–102/MWh (Lazard 2023); the DOE Earthshot targets $45/MWh by 2035. For comparison, solar took roughly 15 years to fall from $496/MWh to ~$60/MWh — geothermal's cost trajectory is decades behind solar's but the DOE is explicitly trying to compress that timeline by transferring drilling techniques from oil and gas. Geothermal is a valuable baseload complement to solar, not a replacement — but the resource base is far larger than early estimates suggested.
- **Nuclear fission** already supplies ~10% of global electricity, and South Korea, France, and China have demonstrated that nuclear-heavy grids work at national scale. The technology is proven, carbon-free, and one of the safest energy sources by deaths-per-TWh — 0.03 deaths/TWh vs coal's 24.6 (even including Chernobyl and Fukushima). But new nuclear is expensive: Lazard (2023) estimates LCOE at $141–221/MWh for new US plants (based on Vogtle costs), vs $24–96/MWh for utility-scale solar PV. Capital costs are $6,695–7,547/kW (EIA 2022) vs $1,327/kW for solar. Once built, existing nuclear runs at just $31/MWh — the cheapest dispatchable low-carbon source — and operates at >90% capacity factor for 40–60 years. The critical difference is learning curves: solar PV module prices follow Wright's Law with a 20.2% learning rate (each doubling of cumulative capacity → 20.2% price decline), falling from $106/watt in 1976 to $0.38/watt — a 99.6% decline. Solar electricity LCOE fell 88% in 15 years ($496→$60/MWh). Nuclear shows no comparable learning curve; in most countries costs have *increased* over time. As Our World in Data summarizes: "No strong price decline anywhere, and certainly nothing that could be characterized by a steep learning curve." However, Berthélemy and Rangel (2015) found that the countries avoiding cost surges — France and South Korea — did so not by regulating less but by *standardizing reactor construction more*. This points to the plausible mechanisms for unlocking nuclear cost reductions: (1) standardized designs built repeatedly (the Korean APR-1400 model), (2) factory-fabricated SMRs enabling serial production rather than bespoke megaprojects, (3) risk-informed regulatory reform that maintains safety while reducing delays, and (4) construction management improvements that prevent the first-of-a-kind cost overruns that plagued Vogtle and Olkiluoto. There is also a firm-power argument: Bank of America's LFSCOE analysis (2023) found that when 100% firm power is required (24/365 guaranteed supply), levelized full-system costs jump to $413–1,548/MWh for solar and $291–504/MWh for wind, but only $106–122/MWh for nuclear — because nuclear doesn't need backup. This doesn't make nuclear cheap in absolute terms, but it changes the comparison for the fraction of the grid that cannot tolerate intermittency. Nuclear's best-case future relies on SMR standardization actually delivering Wright's Law dynamics through serial factory production — plausible but not yet demonstrated at commercial scale.
- **Fusion** is the wildcard. Commonwealth Fusion Systems (MIT spinout) demonstrated a 20-tesla superconducting magnet in 2021 and targets net-energy demonstration in the late 2020s. Private American companies (CFS, TAE Technologies, Helion) and the Chinese government both appear to be gearing up for a race — the dynamics of which (private enterprise vs. state-directed programs) will be instructive in their own right. Even optimistic timelines put commercial fusion in the 2040s at earliest, too late for the critical 2030s transition. But if it arrives, it provides effectively unlimited clean baseload for the second half of the century.

The key insight is not that these alternatives are equal competitors to solar — they are not. Solar's S-curve is the strongest evidence for energy abundance, and the argument stands or falls primarily on whether that curve continues. But nuclear and geothermal reduce total dependence on batteries to smooth the load curve, and fusion could transform the second half of the century. The energy abundance thesis is strongest as a portfolio: solar for the bulk of generation, geothermal and nuclear for baseload, batteries and demand response for balancing, and fusion as a potential long-term accelerant.
...
**But "everything must go right" may be the wrong frame.** Human civilization has always been building the plane while flying it — racing to innovate past looming threats to survival, whether thermodynamic, environmental, or social. The Bronze Age Collapse (~1200 BCE), the fall of Rome, the Black Death: each was a catastrophic failure to maintain civilizational complexity, and each resulted in centuries of degrowth that was *miserable*, not orderly. GDP per capita in Western Europe did not recover to Roman levels until roughly 1500 — a millennium of involuntary degrowth. The Black Death killed 30–60% of Europe's population before the survivors' higher per-capita resources eventually accelerated innovation. These are not arguments for complacency. They are evidence that degrowth, when it has occurred historically, has been catastrophic rather than managed — and that the alternative to successful innovation has never been a graceful retreat to a simpler life, but collapse, famine, and mass death.

What *is* different now is the toolkit. Bronze Age societies had no scientific method, no global communication, no ability to deliberately direct R&D spending toward identified problems. We have all three — and the energy transition is arguably the largest directed technological effort in human history. The question is not whether we face grave threats (we do) but whether our capacity for *directed* innovation — rather than the trial-and-error that characterized pre-modern adaptation — is fast enough to outrun them. The honest answer is: probably, for energy and carbon; uncertain, for nitrogen and biodiversity; and the historical record of civilizational collapse should make anyone who proposes "just consume less" as a primary strategy deeply uncomfortable with the risks of that bet.
...
**The honest history is uncomfortable.** Britain's industrial revolution — the original capital accumulation — was partly funded by colonial profits, slave-trade triangular trade, and the enclosure of the commons that dispossessed peasants from shared land. Marx called this "primitive accumulation" and the critique has real empirical support, even if the magnitudes are debated (slave-trade profits were perhaps 1–5% of British GDP — not the whole story, but not nothing). An anti-capitalist reading stops here: capitalism's startup capital was stolen, therefore the system is illegitimate. But the crucial evidence for today's question is that the *first* industrialization's ugly origins are not a *requirement* of the mechanism. South Korea, Taiwan, Singapore, and China were *colonized* countries, not colonizers. Their capital came from domestic savings, state-directed banking, and FDI — not from plunder. The honest position is: the historical record of original accumulation is genuinely ugly, *and* the development mechanism demonstrably works without repeating it.
...
**Pay-as-you-go solar is the productive-debt thesis made concrete at household scale.** Companies like M-KOPA, d.light, and BBOXX provide solar home systems (panel, battery, lights, phone charger) to off-grid households for zero upfront cost. The customer pays $0.50–1.50/day via mobile money — typically *less* than they were spending on kerosene. After 12–24 months, they own the system outright. This is capitalism's debt mechanism working at the very bottom of the income pyramid: the household "borrows" a productive asset (by committing to future payments), the asset immediately generates returns exceeding the payment cost (light for studying and working, phone charging that enables market access, elimination of kerosene expense), and the customer ends up owning wealth they could never have purchased upfront. Foreign investors fund the solar companies; mobile money makes micro-payments viable; cheap solar panels make the economics work. It is FDI → productive asset → household wealth creation, enabled by mobile financial infrastructure and falling energy costs — the entire development story in miniature.
...
The data reveals the distinction clearly:
...
The correlation between *external* debt service and growth is statistically significant (r = –0.48, p = 0.024 across 25 countries, 2000–2023). But the mechanism matters: it's not that borrowing is bad — it's that external borrowing on commercial terms creates specific vulnerabilities that domestic savings-funded investment does not. External debt must be repaid in foreign currency (creating exchange-rate risk), is subject to creditor conditions (creating sovereignty risk), and carries higher interest rates than domestic savings mobilization.

![Debt service vs revenue](charts/69_debt_service_vs_revenue.png)
*The real constraint is what share of government revenue goes to creditors rather than investment. SSA peaked at 50%+ in the early 1990s, fell to ~5% after HIPC/MDRI debt relief, and is now climbing back toward 15%. Development successes stayed at 5–15% throughout — not because they didn't borrow, but because they borrowed domestically and invested productively.*

The history tells a story of productive versus unproductive debt. East Asian success countries mobilized enormous capital — but primarily from domestic savings (30–45% of GDP), channeled through state-directed banking systems into infrastructure and export industries that generated returns well above the cost of capital. This is capitalism's debt mechanism working as designed. Latin America and SSA, by contrast, borrowed externally — often on commercial terms, sometimes to fund consumption or military spending, and frequently under conditions imposed by creditors whose interests diverged from the borrowers'. Latin America's "lost decade" (1982–1992) was a debt crisis that only ended with Brady Plan restructuring. SSA's HIPC (1996) and MDRI (2005) debt relief dropped external debt from ~100% to ~25% of GNI, creating fiscal space that accelerated growth — but new borrowing since 2010, increasingly from China and commercial creditors (Eurobonds) on less concessional terms, has rebuilt the debt to ~45% of GNI. Ghana, Zambia, and Ethiopia all defaulted or restructured in 2020–2024.

**The distinction is not debt versus no debt — it is productive debt versus extractive debt.** When borrowing funds infrastructure, factories, and human capital that generate returns above the interest rate, debt accelerates development. When it funds consumption, services prior bad debts, or flows to offshore accounts, it becomes a trap. Many SSA countries now pay *more* in debt service than they receive in ODA — Zambia, Ghana, and Kenya each spend 15–20% of government revenue on creditors rather than investment. The composition matters: SSA's new debt is 40–60% private/commercial (vs. mostly concessional multilateral pre-HIPC), with shorter maturities and higher interest rates, making it harder to restructure and more likely to crowd out productive spending.

**Debt restructuring can be a bigger lever than aid — but the deeper problem is building the domestic savings and institutional capacity that let countries borrow productively.** HIPC/MDRI demonstrated that debt relief creates fiscal space; the subsequent re-accumulation demonstrates that without the underlying growth drivers (savings, exports, institutions), the debt rebuilds on worse terms. The goal is not to eliminate borrowing but to shift from external dependence to domestic capital mobilization — which circles back to the development recipe: savings, investment, institutions.
